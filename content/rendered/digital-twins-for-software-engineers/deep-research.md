...
[1]. Architecturally, most sources converge on a layered
stack: a physical asset, a data/connectivity layer, one or more models, and
a service layer exposing the twin's outputs [2]
[3]. Model-driven engineering (MDE) is repeatedly
...
notation [5]. `GreenhouseDT` frames a twin as a layered,
self-adaptive *system*, not a static model, with feedback loops that
themselves need engineering and testing [6].
...
[7]. That testing problem is concrete: cyber-physical
...
[8], and reproducibility work on the PiCar-X
...
[1] [5], while standardization efforts
...
[10]. A second tension: the MDE literature treats a digital
twin primarily as a modeling artifact [4], while
...
[11]. Second, lifecycle management: a twin's models
...
[10]. What does *not* carry over unchanged is testing: a
...
supported claim in the corpus [1]. **Hidden connection,**
...
TwinOps names explicitly [7]. **Actionable insight:**
...
beyond the interview-based cases studied so far [8]?
...
[1] M. Liu, S. Fang, H. Dong, and C. Xu, "Review of digital twin about concepts, technologies, and industrial applications," *Journal of Manufacturing Systems*, vol. 58, pp. 346–361, 2021.
...
[4] J. Michael et al., "Model-Driven Engineering for Digital Twins: Opportunities and Challenges," *Systems Engineering*, vol. 28, no. 5, pp. 659–670, 2025.

[5] F. Tao et al., "makeTwin: A reference architecture for digital twin software platform," *Chinese Journal of Aeronautics*, vol. 37, no. 1, pp. 1–18, 2024.

[6] E. Kamburjan et al., "GreenhouseDT: An Exemplar for Digital Twins," in *Proceedings of the 19th International Symposium on Software Engineering for Adaptive and Self-Managing Systems*, pp. 175–181, Association for Computing Machinery, 2024.

[7] J. Hugues, J. Yankel, J. Hudak, and A. Hristozov, "Twinops: Digital twins meets devops," *CARNEGIE-MELLON UNIV PITTSBURGH PA, Tech. Rep.*, 2022.
...
[9] A. Barbie and W. Hasselbring, *Toward Reproducibility of Digital Twin Research: Exemplified with the PiCar-X*, arXiv, 2024.

[10] G. Shao, S. Frechette, and V. Srinivasan, *An Analysis of the New ISO 23247 Series of Standards on Digital Twin Framework for Manufacturing*, American Society of Mechanical Engineers Digital Collection, 2023.
